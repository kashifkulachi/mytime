  ...
  if (variant === "header") {
    return (
      <button
        ...
        className="flex h-9 cursor-pointer items-center gap-2 rounded-lg px-3 text-sm font-medium text-slate-600 transition-colors duration-200 hover:bg-red-50 hover:text-red-600 disabled:cursor-not-allowed disabled:opacity-60"
      >
        {isPending ? (
          <Loader2
            className="h-[17px] w-[17px] shrink-0 animate-spin"
            aria-hidden="true"
          />
        ) : (

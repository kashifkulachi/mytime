...
export default function SignupForm() {
  ...
  const onSubmit = (values: SignupInput) => {
    startTransition(async () => {
       ...
       *
       * replace() is preferable here so the newly-created
       * signup page is not kept as a useful browser-history
       * destination.
       */
                  ...
                  <Field data-invalid={fieldState.invalid}>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer text-slate-600 transition hover:text-slate-950 disabled:pointer-events-none disabled:opacity-50"
                        aria-label={
